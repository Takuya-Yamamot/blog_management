    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('breif', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mgblog.Breif')),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('client_creative_brief', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mgblog.Breif')),
                ('plan_overview', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mgblog.PlanOverView')),
            ],
        ),
        migrations.AddField(
            model_name='breif',
